    ...
    <div className="bg-slate-100 w-full h-full p-4">
      ...
      <div className="bg-white shadow-md rounded-md relative mb-4">
        <div className='relative'>
          ...
          <img className='rounded-full w-[120px] h-[120px] object-cover absolute bottom-0 translate-y-[50%] left-[50%] translate-x-[-50%]' src={users[userId-1].image} alt="" />
        </div>
        <div className='mt-16 p-4 flex flex-col items-center'>
          <div className='flex items-center'>
            <h1 className='font-semibold'>{users[userId-1].username}</h1>
          </div>
          <div className='my-2 text-center'>
            <h4 className='text-sm text-slate-400 tracking-wide	'>{users[userId-1].email}</h4>
            <h4 className='text-sm text-slate-400 tracking-wide	'>{users[userId-1].phone}</h4>
          </div>
          <p className='text-asp-yellow font-semibold tracking-wider'>{users[userId-1].position}</p>
        </div>
      </div>
      ...
      <div className='bg-white shadow-md rounded-md p-4 mb-4'>
        ...
        <div className='py-4 flex flex-col gap-2'>
          <div>
            ...
            <p className='text-sm '>{users[userId-1].address}</p>
          </div>
          <div>
